...
def menu():
    ...
    while True:
        ...
        if program in ['calculator', 'c']:
            ...
            exit()  # Use sys.exit() to exit gracefull
        else:
            return False
def calculator(): 
    print("")
    ...
    while True:
        ...
        if operation in ['+', 'plus']:
            ...
            print("please enter a valuid input")
            return False
def returnC():
...
def plus():
    ...
    while True: 
        try:
            ...
            wait = input("Type 'exit' to quit or press Enter to continue: ").lower()
            if wait == 'exit':
                returnC() 
        except ValueError:
...
def hardcore():
    ...
    wait = input("Type 'exit' to quit or press Enter to try again: ").lower()
    if wait in ['exit',"e"]:
        returnTable()
    else:
        Go()
def Go():
    ...
    with open('Mathlab.csv', mode='w', newline='') as file:
        ...
        csv_writer.writerow(header)  
        csv_writer.writerows(rows)   
    wait = input("Type 'exit' to quit or press Enter to try agin: ").lower()
    if wait in ['exit',"e"]:
        returnTable()
    else:
        Go()
